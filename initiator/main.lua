...
function _M:init_worker()
    ...
    metric_response_sizes = prometheus:histogram("response_sizes_bytes", "Size of HTTP responses", {"host"}, {10, 100, 1000, 10000, 100000, 1000000})
    metric_bytes = prometheus:counter("request_sizes_bytes","Total size of incoming requests", {"host"})
    metric_requests_per_second = prometheus:counter("requests_per_second_total", "Number of HTTP requests per second", {"host"})
